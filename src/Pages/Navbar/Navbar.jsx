...
const Navbar = () => {
    ...
    const navLinks = <>
        ...
        <li><NavLink to="/updateProfile">Add Craft</NavLink></li>
        ...
        <div className="container m-auto">
            <div className="navbar">
                ...
                <div className="navbar-end flex gap-4">
                    {
                        <div className="btn btn-ghost btn-circle avatar tooltip tooltip-bottom z-[999]" data-tip="{user.displayName}">
                            <div className="w-full rounded-full">
                                <img alt="Profile" src="https://daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg" />
                            </div>
                        </div>
                    }
                    {
